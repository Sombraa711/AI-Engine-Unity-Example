...
public class gusto_engine_wrapper_example : MonoBehaviour
{    
    ...
    void Start()
    {
        ...
        // string t_modelpath = Gusto.Utility.retrieve_streamingassets_data("Weights/end2end_nonms_fp16.onnx");
        // string t_clsnamespath = Gusto.Utility.retrieve_streamingassets_data("Weights/rtm_test_cat.names");
